...
LexicalClass lexicalClasses[] = {
	...
	7, "SCE_DART_TRIPLE_STRING_SQ", "literal multiline string", "Single quoted multiline string",
	8, "SCE_DART_TRIPLE_STRING_DQ", "literal multiline string", "Double quoted multiline string",
	9, "SCE_DART_RAWSTRING_SQ", "literal raw string", "Single quoted raw string",
	10, "SCE_DART_RAWSTRING_DQ", "literal raw string", "Double quoted raw string",
	11, "SCE_DART_TRIPLE_RAWSTRING_SQ", "literal multiline raw string", "Single quoted multiline raw string",
	12, "SCE_DART_TRIPLE_RAWSTRING_DQ", "literal multiline raw string", "Double quoted multiline raw string",
	13, "SCE_DART_ESCAPECHAR", "escape character", "Escape character",
	14, "SCE_DART_IDENTIFIER", "identifier", "Identifier",
	15, "SCE_DART_IDENTIFIER_STRING", "string interpolation identifier", "Identifier following $ inside strings",
	16, "SCE_DART_OPERATOR", "operator", "Operator",
	17, "SCE_DART_OPERATOR_STRING", "string interpolation operator", "Braces following $ inside string",
	18, "SCE_DART_SYMBOL_IDENTIFIER", "symbol identifier", "Symbol name introduced by #",
	19, "SCE_DART_SYMBOL_OPERATOR", "symbol operator", "Operator introduced by #",
	20, "SCE_DART_NUMBER", "number", "Number",
	21, "SCE_DART_KEY", "key", "Keys preceding ':' and named parameters",
	22, "SCE_DART_METADATA", "metadata", "Metadata introduced by @",
	23, "SCE_DART_KW_PRIMARY", "primary keyword", "Primary keywords",
	24, "SCE_DART_KW_SECONDARY", "secondary keyword", "Secondary keywords",
	25, "SCE_DART_KW_TERTIARY", "tertiary keyword", "Tertiary keywords",
	26, "SCE_DART_KW_TYPE", "global type", "Global types",
};
